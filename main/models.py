...
class VendorProfile(models.Model):
    user = models.OneToOneField('accounts.User', on_delete=models.CASCADE, related_name='v_data')
...
class Order(models.Model):
    ...
    vendor = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name='vendor_orders', null=True)
    ...
    order_status = models.CharField('Order Status', max_length=255, choices=OrderStatusChoices)
