            ...
            try:
                ...
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Error Retrieving Error {str(e)}",
                    },
                )
            else:
                return JSONResponse(
        ...
        try:
            ...
            if not (
                ...
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"user_id or vendor_id or pickup_address or package_size_in_kg or description or dropoff_address or amount cannot be null",
                    },
                )
            ...
            try:
                new_order = Order.objects.create(
                    ...
                    package_size_in_kg=package_size_in_kg,
        ...
        if not order_id:
            return JSONResponse(
                ...
                data={
                    "response_code": 400,
                    "response_status": "error",
                    "message": f"Order ID cannot be null",
                },
            )
    ...
    if request.method == "POST":
        ...
        try:
            ...
            order.pickup_address = (
                pickup_address if pickup_address else order.pickup_address
            )
            order.dropoff_address = (
                dropoff_address if dropoff_address else order.dropoff_address
            )
            order.package_size_in_kg = (
                package_size_in_kg if package_size_in_kg else order.package_size_in_kg
            )
        ...
        try:
            ...
            return JSONResponse(
                ...
                data={
                    "response_code": 400,
                    "response_status": "error",
                    "message": f"Unable to decode data {str(e)}",
                },
            )
        else:
            ...
            if not order_id:
                ...
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Order is already accepted by a vendor",
                    },
                )
            else:
                Order.objects.filter(order_id=order_id).update(
                    is_accepted=True, vendor=user
                )
                return JSONResponse(
                    status=200,
                    data={
...
def get_average_ratings_view(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            try:
                ratings_list = [
                    x.review.rating for x in Order.objects.filter(vendor=user)
                ]
                ...
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Error Retrieving average rating {e}",
                    },
                )
            else:
                return JSONResponse(
            ...
            if not (rating and order_id):
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Rating or Order ID cannot be null",
                    },
                )
            if not Order.objects.filter(order_id=order_id):
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Order matching provided id not found",
                    },
                )
            if int(rating) not in range(1, 6):
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Invalid Rating Provided",
                    },
                )

            try:
                rev = Reviews.objects.create(
                    order=Order.objects.get(order_id=order_id), rating=int(rating)
                )
            except Exception as e:
                return JSONResponse(
                    status=400,
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Error creating review {e}",
                    },
                )
            else:
                return JSONResponse(
            ...
            try:
                ...
                return JSONResponse(
                    ...
                    data={
                        "response_code": 200,
                        "response_status": "success",
                        "message": f"Review deleted successfully",
                    },
                )
...
def add_comment_view(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if not (review_id and text_data):
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Review Id and Text_data cannot be null",
                    },
                )
            if not Reviews.objects.filter(review_id=review_id):
                return JSONResponse(
            ...
            try:
                comment = Comments.object.create(
                    user=user,
                ...
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Unable to create Comment{e}",
                    },
                )
            else:
                return JSONResponse(
            ...
            if not comment_id:
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"comment_id cannot be none",
                    },
                )
            if not Comments.objects.filter(id=int(comment_id)):
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"comment_id not found",
                    },
                )
            ...
            if not Reviews.objects.filter(review_id=review_id):
                return JSONResponse(
                    ...
                    data={
                        "response_code": 400,
                        "response_status": "error",
                        "message": f"Review matching review id not found",
                    },
                )
            ...
            if not review.comments.count():
                return JSONResponse(
                    ...
                    data={
                        "response_code": 200,
                        "response_status": "success",
                        "message": f"Review matching review id has no comments",
                        "data": [],
                    },
                )

            comments = [
                model_to_dict(x) for x in Comments.objects.filter(review=review)
            ]
            return JSONResponse(
                status=400,
                data={
